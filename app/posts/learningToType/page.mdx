...
your fingers extend up and down, so the keys should also be directly on top of one another.

## Thumb clusters

On a standard keyboard, both of your thumbs are resigned to pressing the space bar — a huge inefficiency.
